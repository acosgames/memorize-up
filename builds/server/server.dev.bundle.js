...
class ACOSG {
    ...
    random() {
        ...
        if (!this.randomFunc) {
            let sequence = this.nextGame?.state?.gamesequence || 0;
            let seedStr = this.nextGame.room_slug + sequence;
            let seed = this.generateRandomSeed(seedStr);
...
/******/ })()
;
//# sourceMappingURL=server.dev.bundle.js.map